...
export class CacheAdapterModule implements OnModuleInit, OnApplicationShutdown {
  ...
  private static createAsyncProviders(options: CacheModuleAsyncOptions): Array<Provider> {
  ...
  private static createAsyncOptionsProvider(options: CacheModuleAsyncOptions): Provider {
    ...
    return {
      ...
      ): CacheModuleOptions | Promise<CacheModuleOptions> => optionsFactory.createModuleOptions(),
