...
export interface DatabaseOptionsFactory {
  createModuleOptions: () => DatabaseModuleOptions | Promise<DatabaseModuleOptions>
}

export interface DatabaseModuleAsyncOptions extends Pick<ModuleMetadata, 'imports' | 'providers'> {
  useExisting?: Type<DatabaseModuleOptions>
  useClass?: Type<DatabaseModuleOptions>
  useFactory?: (...args: Array<any>) => DatabaseModuleOptions | Promise<DatabaseModuleOptions>
